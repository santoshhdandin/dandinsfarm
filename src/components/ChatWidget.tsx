  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-48 right-6 w-16 h-16 rounded-full shadow-2xl flex items-center justify-center z-50 transition-all duration-300 ${isOpen ? 'scale-0' : 'scale-100'
          }`}
        style={{
